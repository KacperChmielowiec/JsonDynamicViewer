...
{
    class NewickCommand : Command
    {
        public override ConsoleTextSpan[] HelpText => new ConsoleTextSpan[]
         {
            new ConsoleTextSpan("  newick\n", 2, ConsoleColor.Green),
            new ConsoleTextSpan("  newick ", 2, ConsoleColor.Green),
            new ConsoleTextSpan("<file name>\n", 2, ConsoleColor.Blue),
            new ConsoleTextSpan("  newick ", 2, ConsoleColor.Green),
            new ConsoleTextSpan("stdout\n", 2, ConsoleColor.Yellow),
            new ConsoleTextSpan("    Outputs the final transformed tree in Newick format to the specified ", 4),
            ...
            new ConsoleTextSpan(" newick ", 4, ConsoleColor.Green),
            ...
            new ConsoleTextSpan("    Outputs the loaded tree(s) in Newick format to the specified ", 4),
            new ConsoleTextSpan("file ", 4, ConsoleColor.Blue),
            new ConsoleTextSpan("or to the standard ", 4),
            new ConsoleTextSpan("output", 4, ConsoleColor.Yellow),
            new ConsoleTextSpan(". If a destination is not specified, the same destination as the previous", 4),
            ...
            new ConsoleTextSpan("    Outputs the first transformed tree in Newick format to the specified ", 4),
            new ConsoleTextSpan("file ", 4, ConsoleColor.Blue),
            new ConsoleTextSpan("or to the standard ", 4),
            new ConsoleTextSpan("output", 4, ConsoleColor.Yellow),
            new ConsoleTextSpan(". If a destination is not specified, the same destination as the previous", 4),
        ...
        {
            new ConsoleTextSpan("Exports a tree in Newick format.")
        };

        public override string PrimaryCommand => "newick";
        ...
        void ExportToStream(Stream stream, int subject)
        {
            using (StreamWriter sw = new StreamWriter(stream))
            {
                ...
                {
                    sw.WriteLine(NWKA.WriteTree(Program.FirstTransformedTree, false, true));
                }
                else if (subject == 2)
                {
                    sw.WriteLine(NWKA.WriteTree(Program.TransformedTree, false, true));
                }
            }
        }
