...
{
    class SVGCommand : Command
    {
        public override ConsoleTextSpan[] HelpText => new ConsoleTextSpan[]
          {
            new ConsoleTextSpan("  svg ", 2, ConsoleColor.Green),
            new ConsoleTextSpan("<file name>\n", 2, ConsoleColor.Blue),
            new ConsoleTextSpan("    Saves a plot of the tree in SVG format with the specified ", 4),
            new ConsoleTextSpan("file name", 4, ConsoleColor.Blue),
            new ConsoleTextSpan(".\n\n", 4),

            new ConsoleTextSpan("  svg ", 2, ConsoleColor.Green),
            new ConsoleTextSpan("stdout\n", 2, ConsoleColor.Yellow),
            new ConsoleTextSpan("    Writes a plot of the tree in SVG format to the standard output.\n\n", 4),

            new ConsoleTextSpan("  svg\n", 2, ConsoleColor.Green),
            new ConsoleTextSpan("    Outputs a plot of the tree in SVG format to the same destination as the previous ", 4),
            new ConsoleTextSpan("svg ", 4, ConsoleColor.Green),
            new ConsoleTextSpan("command (default: standard output).", 4),
          };

        public override ConsoleTextSpan[] ShortHelpText => new ConsoleTextSpan[]
        {
            new ConsoleTextSpan("Plots the tree in SVG format.")
        };

        public override string PrimaryCommand => "svg";
        ...
        private void OutputSVGToStream(Stream sr)
        {
