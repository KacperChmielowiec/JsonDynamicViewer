...
public class Lab6 extends GLJPanel implements GLEventListener  {
	...
	public void drawPyram(GL2 gl2, int c) {
		double radius = 5.5;
		double angle = 0;
		double angle_rise = 2 * Math.PI / c;
		float x = 0, z = 0;
		float[] material = materials[1];
		...
		for (int i = 1; i <= c; i++) {
			...
			gl2.glMaterialfv (GL2.GL_FRONT_AND_BACK, GL2.GL_AMBIENT_AND_DIFFUSE, material, 0);

			gl2.glVertex3f( 0.0f, 7.5f, 0.0f);
			gl2.glMaterialfv (GL2.GL_FRONT_AND_BACK, GL2.GL_AMBIENT_AND_DIFFUSE, material, 4);
			...
			gl2.glMaterialfv (GL2.GL_FRONT_AND_BACK, GL2.GL_AMBIENT_AND_DIFFUSE, material, 8);
	...
	public void init(GLAutoDrawable drawable) {
		...
		float[] ambientLevel = { 0.2f, 0.2f, 0.2f, 1f };
		gl2.glLightModelfv(GL2.GL_LIGHT_MODEL_AMBIENT,ambientLevel, 4);
