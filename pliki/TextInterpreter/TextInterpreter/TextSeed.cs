...
{
    internal class TextSeed
    {
        public Tuple<string, string>[] getStringData()
        {
            string s1 = @"Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of 
            ...
            string s2 = @"It is a long established fact that a reader will be distracted by the readable content of 
            ...
            return new Tuple<string, string>[] { new Tuple<string, string>("name_1", s1), new Tuple<string, string>("name_2", s2) };
        }
