    ...
    JMenuBar getMenuBar() {
        ...
        ActionListener textureListener = e -> {
            ...
            switch (itemNum) {
                ...
                case 3:
                    try {
                        currentTexture = textureFromResource("C:\\Users\\kacper\\eclipse-workspace5\\lab7\\src\\lab7\\res\\earth.jpg");
                ...
                case 4:
                    try {
                    	 currentTexture = textureFromResource("C:\\Users\\kacper\\eclipse-workspace5\\lab7\\src\\lab7\\res\\brick.jpg");
                    } catch (IOException ex) {
                        ex.printStackTrace();
                    }
                    break;
                case 5:
                    try {
                    	 currentTexture = textureFromResource("C:\\Users\\kacper\\eclipse-workspace5\\lab7\\src\\lab7\\res\\clouds.jpg");
                    } catch (IOException ex) {
                        ex.printStackTrace();
                    }
                    break;
